...
1. [Описание задачи]Модель предсказывает ожидаемую сумму покупки, опираясь на признаки события заказа, товарной категории, временной метки и пользовательской активности
